 ...
 * all of the basics of scheduling capabilities of Quartz using Simple Triggers.
 *
 * SimpleTrigger主要用于“一次性”(one-shot)执行的Job（只在某个特定的时间点执行一次），或者Job在特定的时间点执行，重复执行N次，每次执行之间延迟T个时间单位
 *
 * @author Bill Kratzer
 */
