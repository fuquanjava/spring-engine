...
public class ShardedJedisPoolTest {
    private static HostAndPort redis1 = new HostAndPort("192.168.1.133", 7000);
    private static HostAndPort redis2 = new HostAndPort("192.168.1.133", 7002);
    ...
    public void checkJedisIsReusedWhenReturned() {
        ...
        System.out.println(jedis.get("foo")); // 1
        pool.destroy();
    }

    @Test
    public void checkPoolRepairedWhenJedisIsBroken() throws InterruptedException {
        ShardedJedisPool pool = new ShardedJedisPool(new GenericObjectPoolConfig(), shards);
